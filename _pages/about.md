...
<img src="{{ '/images/usenixbadges-functional-v2.png' | relative_url }}" width="55">
<img src="{{ '/images/usenixbadges-reproduced-v2.png' | relative_url }}" width="55"> Congrats!
...
- <span class="badge" style="vertical-align: top;">USENIX Security'26</span> **What the Eyes See, the LLMs Miss: Exploiting Human Perception for Adversarial Text Attacks**  
  ...
  *In Proceedings of the 35th USENIX Security Symposium (USENIX Security), Baltimore, MD, USA, August 12-14, 2026* (Acceptance Rate: <a href="https://openaccept.org/c/sec/usenix-security/" target="_blank">[(362/3,028 = 12.0%)]</a>) \| 
